    ...
    render: function() {
        ...
        return (
            <div className="resume-container animated fadeInUp">
                ...
                <ExperienceList type="social" experiences={this.props.resume.socialExperiences}/>
                <ExperienceList type="Intern" experiences={this.props.resume.InternExperiences}/>
                <ExperienceList type="Project" experiences={this.props.resume.ProjectExperience}/>
            </div>
        )
    }
});
